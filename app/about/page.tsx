    ...
    return (
        <div className="container py-20 px-4 md:px-8 mx-auto">
            ...
            <div className="max-w-3xl mx-auto text-center mb-16">
                ...
                <h1 className="text-4xl font-bold tracking-tight mb-6">Greenfield Global</h1>
                <p className="text-xl text-muted-foreground leading-relaxed">
                    Greenfield Global is an independently operated AI and automation review platform dedicated to helping professionals and businesses navigate the rapidly evolving world of AI tools.
                </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                            <div className="prose prose-gray">
                                <p className="text-lg text-muted-foreground mb-4">
                                    Greenfield Global is driven by a team with deep expertise in:
                                </p>
                                ...
                                <Card className="border-primary/10 shadow-sm">
                                    <CardContent className="pt-6">
                                        <p className="text-muted-foreground mb-4">
                                            Greenfield Global is operated with professional editorial standards, ethical publishing practices, and clear transparency.
                                        </p>
            ...
            <div className="mb-24 text-center">
                ...
                <p className="mt-12 text-lg text-muted-foreground font-medium max-w-3xl mx-auto">
                    Every review published on Greenfield Global is written with the reader's interest as the top priority.
                </p>
            </div>
