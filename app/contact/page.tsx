...
import { Mail, Network, Clock } from "lucide-react";
        ...
        <div className="container py-20 px-4 md:px-8 mx-auto">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-bold tracking-tight mb-4">Contact Greenfield Global</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div>
                        <div className="space-y-12">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-lg text-primary">📧 support@greenfieldglobal.online</p>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="bg-muted/30 p-6 rounded-xl border border-border/50">
                                    <p className="font-bold text-lg mb-1">Greenfield Global Editorial Team</p>
                                    <p className="text-sm text-muted-foreground mb-4">Independent reviewers and AI specialists dedicated to providing unbiased, research-driven content.</p>
                                </div>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="text-xs text-center text-muted-foreground">
                            Greenfield Global is an independently operated informational website.
                        </p>
                    </div>
                </div>
            </div>
