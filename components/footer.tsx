        ...
        <footer className="bg-muted/30 border-t">
            <div className="container mx-auto px-4 md:px-8 py-12">
                    ...
                    <div className="space-y-4">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="font-bold text-xl tracking-tight text-foreground">
                                Greenfield <span className="text-primary">Global</span>
                            </span>
                        </Link>
                        ...
                        <div className="flex gap-4">
                            <Link href="https://www.instagram.com/greenfieldglobal/" className="text-muted-foreground hover:text-primary transition-colors">
                                <FaInstagram className="h-5 w-5" />
                            </Link>
                            <Link href="https://www.x.com/greenfieldglobal" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <div className="text-center text-sm text-muted-foreground">
                    &copy; {new Date().getFullYear()} Greenfield Global. All rights reserved.
                </div>
            </div>
        </footer>
    );
